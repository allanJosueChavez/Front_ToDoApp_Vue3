...
<template>
  ...
  <div class="sm:flex h-screen w-full">
    ...
    <div
      id="to-do-list"
      class="sm:w-4/5 bg-gradient-to-b from-purple-100 to-yellow-100"
    >
      <div class="h-full animate-right space-y-6 pb-14 pt-4 px-10">
        <section class="  align-center flex bg-red h-20">
        ...
        <section id="to-dos" class="bg-sky-400 todo-list h-4/6 overflow-y-auto">
        </section>
      </div>
    </div>
  </div>
